...
/* harmony export */   "default": () => (/* binding */ ActionsRival)
/* harmony export */ });
...
var ActionsRival = /*#__PURE__*/_createClass(function ActionsRival(objPos, indTarget, isAttack) {
  _classCallCheck(this, ActionsRival);
...
/* harmony import */ var _generators__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./generators */ "./src/js/generators.js");
/* harmony import */ var _PositionedCharacter__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./PositionedCharacter */ "./src/js/PositionedCharacter.js");
/* harmony import */ var _characters_Bowman__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./characters/Bowman */ "./src/js/characters/Bowman.js");
/* harmony import */ var _characters_Swordsman__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./characters/Swordsman */ "./src/js/characters/Swordsman.js");
/* harmony import */ var _characters_Magician__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./characters/Magician */ "./src/js/characters/Magician.js");
/* harmony import */ var _characters_Vampire__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./characters/Vampire */ "./src/js/characters/Vampire.js");
/* harmony import */ var _characters_Undead__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./characters/Undead */ "./src/js/characters/Undead.js");
/* harmony import */ var _characters_Daemon__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./characters/Daemon */ "./src/js/characters/Daemon.js");
/* harmony import */ var _GamePlay__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./GamePlay */ "./src/js/GamePlay.js");
/* harmony import */ var _GameState__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./GameState */ "./src/js/GameState.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./utils */ "./src/js/utils.js");
/* harmony import */ var _cursors__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./cursors */ "./src/js/cursors.js");
/* harmony import */ var _ActionsRival__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./ActionsRival */ "./src/js/ActionsRival.js");
/* harmony import */ var _Team__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./Team */ "./src/js/Team.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var GameController = /*#__PURE__*/function () {
  function GameController(gamePlay, stateService) {
    ...
    this.gameState = new _GameState__WEBPACK_IMPORTED_MODULE_37__["default"]();
    this.pointCells;
  ...
  _createClass(GameController, [{
    ...
    value: function firstInit() {
      ...
      this.gamePlay.drawUi(_themes__WEBPACK_IMPORTED_MODULE_27__["default"].prairie);
      this.pointCells = (0,_utils__WEBPACK_IMPORTED_MODULE_38__.getGameFieldMarkings)(this.gamePlay.boardSize);
      this.gameState.positionedCharacters = [];
      this.gameState.teamPlayer = new _Team__WEBPACK_IMPORTED_MODULE_41__["default"]((0,_generators__WEBPACK_IMPORTED_MODULE_28__.generateTeam)([_characters_Bowman__WEBPACK_IMPORTED_MODULE_30__["default"], _characters_Swordsman__WEBPACK_IMPORTED_MODULE_31__["default"], _characters_Magician__WEBPACK_IMPORTED_MODULE_32__["default"]], this.gameState.level, 4));
      this.gameState.teamRival = new _Team__WEBPACK_IMPORTED_MODULE_41__["default"]((0,_generators__WEBPACK_IMPORTED_MODULE_28__.generateTeam)([_characters_Vampire__WEBPACK_IMPORTED_MODULE_33__["default"], _characters_Undead__WEBPACK_IMPORTED_MODULE_34__["default"], _characters_Daemon__WEBPACK_IMPORTED_MODULE_35__["default"]], this.gameState.level, 4));
    ...
    key: "initialPositionChar",
    value: function initialPositionChar(arr, team) {
      var _iterator = _createForOfIteratorHelper(team.characters),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var player = _step.value;
          var cellIndex = (0,_generators__WEBPACK_IMPORTED_MODULE_28__.cellsGenerator)(arr.length).next().value;
          this.gameState.positionedCharacters.push(new _PositionedCharacter__WEBPACK_IMPORTED_MODULE_29__["default"](player, arr[cellIndex]));
    ...
    key: "getInitialCellsPlayers",
    value: function getInitialCellsPlayers() {
      return [0, 1, 8, 9, 16, 17, 24, 25, 32, 33, 40, 41, 48, 49, 56, 57];
    }
  }, {
    key: "getInitialCellsRiv",
    value: function getInitialCellsRiv() {
      return [6, 7, 14, 15, 22, 23, 30, 31, 38, 39, 46, 47, 54, 55, 62, 63];
    }
  }, {
    key: "getArrCellForAttack",
    value: function getArrCellForAttack(objPos, teamAttack) {
      var _this = this;
      // teamAttack - команда, которую атакуют

      var allIndex = [];
      var maxStep = objPos.character.rangeAttack;
      var pointCell = this.pointCells.find(function (_ref) {
        var index = _ref.index;
        return index == _this.gameState.selected;
      });
      var initPoint = [Math.max(pointCell.row - maxStep, 0), Math.max(pointCell.column - maxStep, 0)]; //в массиве x,y координаты
      var endPoint = [Math.min(pointCell.row + maxStep, this.gamePlay.boardSize - 1), Math.min(pointCell.column + maxStep, this.gamePlay.boardSize - 1)]; //в массиве x,y координаты
      // let str = `initPoint=${initPoint}, endPoint=${endPoint}`;
      //alert(str);

      var startX = initPoint[0];
      var endX = endPoint[0];
      var startY = initPoint[1];
      var endY = endPoint[1];
      var _loop = function _loop(i) {
        var _loop2 = function _loop2(j) {
          pointCell = _this.pointCells.find(function (_ref2) {
            var row = _ref2.row,
              column = _ref2.column;
      ...
      var allIndAttack = [];
      var _iterator2 = _createForOfIteratorHelper(this.gameState.positionedCharacters),
        _step2;
      try {
        var _loop3 = function _loop3() {
          var pos = _step2.value;
          var typeChar = pos.character.type;
          if (teamAttack.characters.find(function (_ref3) {
            var type = _ref3.type;
    ...
    key: "getArrCellForMov",
    value: function getArrCellForMov(objPos) {
      var _this2 = this;
      var allIndex = [];
      var maxStep = objPos.character.rangeMov;
      var pointCell = this.pointCells.find(function (_ref4) {
        var index = _ref4.index;
        return index == _this2.gameState.selected;
      });
      var initPoint = [Math.max(pointCell.row - maxStep, 0), Math.max(pointCell.column - maxStep, 0)]; //в массиве x,y координаты
      var endPoint = [Math.min(pointCell.row + maxStep, this.gamePlay.boardSize - 1), Math.min(pointCell.column + maxStep, this.gamePlay.boardSize - 1)]; //в массиве x,y координаты
      ...
      var _loop4 = function _loop4(i) {
        var _loop5 = function _loop5(j) {
          pointCell = _this2.pointCells.find(function (_ref5) {
            var row = _ref5.row,
              column = _ref5.column;
            return row == i && column == j;
          });
      ...
      var _iterator3 = _createForOfIteratorHelper(this.gameState.positionedCharacters),
        _step3;
      try {
        var _loop6 = function _loop6() {
          var pos = _step3.value;
          var ind = allIndex.find(function (index) {
    ...
    key: "setTargetCursor",
    value: function setTargetCursor(objPos, index) {
      var isCharPlayer = false;
      var isCharRiv = false;
      if (objPos) {
        isCharPlayer = this.gameState.teamPlayer.characters.find(function (_ref6) {
          var type = _ref6.type;
          return type == objPos.character.type;
        }) !== undefined;
        isCharRiv = this.gameState.teamRival.characters.find(function (_ref7) {
          var type = _ref7.type;
          return type == objPos.character.type;
        }) !== undefined;
      }
      if (objPos && this.gameState.selected !== objPos.position && isCharPlayer) {
        // навели курсор на невыбранном игроке
        this.gamePlay.setCursor(_cursors__WEBPACK_IMPORTED_MODULE_39__["default"].pointer);
        return;
      }
      if (this.gameState.selected === null) {
        this.gamePlay.setCursor(_cursors__WEBPACK_IMPORTED_MODULE_39__["default"].auto);
        return;
      }

      // определяем, что курсор на свободной клетке, куда можно переместиться
      if (!(this.cellsMov.find(function (elem) {
        return elem == index;
      }) === undefined)) {
      ...
      if (isCharRiv) {
        if (!(this.cellsAttack.find(function (ind) {
          return ind == index;
        }) === undefined)) {
          this.gamePlay.selectCell(index, 'red');
          this.gamePlay.setCursor(_cursors__WEBPACK_IMPORTED_MODULE_39__["default"].crosshair);
          return;
        } else {
          this.gamePlay.setCursor(_cursors__WEBPACK_IMPORTED_MODULE_39__["default"].notallowed);
          return;
        }
      }
      this.gamePlay.setCursor(_cursors__WEBPACK_IMPORTED_MODULE_39__["default"].auto);
    ...
    key: "execRivActions",
    value: function execRivActions() {
      var _this3 = this;
      // выполнение ходов соперника
      if (this.gameState.teamRival.characters.length === 0) {
        return;
      }
      var actions = [];
      var rivs = [];
      var _iterator4 = _createForOfIteratorHelper(this.gameState.positionedCharacters),
        _step4;
      try {
        var _loop7 = function _loop7() {
          var pos = _step4.value;
          if (_this3.gameState.teamRival.characters.find(function (_ref9) {
            var type = _ref9.type;
            return type == pos.character.type;
          })) {
            rivs.push(pos);
          }
        };
      ...
      for (var _i = 0, _rivs = rivs; _i < _rivs.length; _i++) {
        var rivPos = _rivs[_i];
        var indMove = this.getArrCellForMov(rivPos);
        var _iterator5 = _createForOfIteratorHelper(indMove),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var ind = _step5.value;
            actions.push(new _ActionsRival__WEBPACK_IMPORTED_MODULE_40__["default"](rivPos, ind, false));
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
        ...
        var indAttack = this.getArrCellForAttack(rivPos, this.gameState.teamPlayer);
        var _iterator6 = _createForOfIteratorHelper(indAttack),
          _step6;
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            var _ind = _step6.value;
            actions.push(new _ActionsRival__WEBPACK_IMPORTED_MODULE_40__["default"](rivPos, _ind, true));
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
      ...
      var indAct = this.randomInteger(0, actions.length - 1);
      var actRiv = actions[indAct];
      var selRivPos = actRiv.objPos;
      if (actRiv.isAttack) {
        var attacker = selRivPos.character;
        var pos = this.gameState.positionedCharacters.find(function (_ref8) {
          var position = _ref8.position;
          return position == actRiv.indTarget;
        });
        var target = pos.character;
        var damage = Math.max(attacker.attack - target.defence, attacker.attack * 0.1);
        var promise = this.gamePlay.showDamage(actRiv.indTarget, damage);
        promise.then(function (response) {
          target.health = Math.max(target.health - damage, 0);
          if (target.health == 0) {
            _this3.deleteChar(pos.position, _this3.gameState.teamPlayer);
          }
          _this3.gamePlay.redrawPositions(_this3.gameState.positionedCharacters);
          if (_this3.gameState.teamPlayer.length == 0) {
            _this3.levelCompletionControl();
            return;
          }
          if (!(_this3.gameState.selected === null)) {
            _this3.gamePlay.deselectCell(_this3.gameState.selected);
            _this3.gameState.selected = null;
          }
          _this3.gameState.myMove = true;
        });
      } else {
    ...
    key: "deleteChar",
    value: function deleteChar(index, team) {
      var pos = this.gameState.positionedCharacters.find(function (_ref10) {
        var position = _ref10.position;
        return position == index;
      });
      var _char = team.characters.find(function (elem) {
        return elem == pos.character;
      });
      team.characters.splice(team.characters.indexOf(_char), 1);
      this.gameState.positionedCharacters.splice(this.gameState.positionedCharacters.indexOf(pos), 1);
    }
  }, {
    key: "levelCompletionControl",
    value: function levelCompletionControl() {
      var _this$gameState$teamP, _this$gameState$teamR;
      var team = undefined; // команда победителя
      ...
      if (this.gameState.level === 4) {
        _GamePlay__WEBPACK_IMPORTED_MODULE_36__["default"].showMessage("\u0418\u0433\u0440\u0430 \u0437\u0430\u043A\u043E\u043D\u0447\u0435\u043D\u0430. \u0412\u0430\u0448 \u0441\u0447\u0435\u0442: ".concat(this.gameState.teamPlayer.scores, ". \u0421\u0447\u0435\u0442 \u0441\u043E\u043F\u0435\u0440\u043D\u0438\u043A\u0430: ").concat(this.gameState.teamRival.scores));
        this.firstInit();
        return;
      }
      team.characters.forEach(function (elem) {
        elem.level++;
        elem.levelUp();
      });
      ...
      this.gameState.myMove = true;
      this.gameState.selected = null;
      this.gamePlay.drawUi((0,_utils__WEBPACK_IMPORTED_MODULE_38__.getTheme)(this.gameState.level));
      var teamPlayer = (0,_generators__WEBPACK_IMPORTED_MODULE_28__.generateTeam)([_characters_Bowman__WEBPACK_IMPORTED_MODULE_30__["default"], _characters_Swordsman__WEBPACK_IMPORTED_MODULE_31__["default"], _characters_Magician__WEBPACK_IMPORTED_MODULE_32__["default"]], this.gameState.level, 4 - this.gameState.teamPlayer.characters.length);
      (_this$gameState$teamP = this.gameState.teamPlayer.characters).splice.apply(_this$gameState$teamP, [this.gameState.teamPlayer.characters.length, 0].concat(_toConsumableArray(teamPlayer)));
      var teamRival = (0,_generators__WEBPACK_IMPORTED_MODULE_28__.generateTeam)([_characters_Vampire__WEBPACK_IMPORTED_MODULE_33__["default"], _characters_Undead__WEBPACK_IMPORTED_MODULE_34__["default"], _characters_Daemon__WEBPACK_IMPORTED_MODULE_35__["default"]], this.gameState.level, 4 - this.gameState.teamRival.characters.length);
      (_this$gameState$teamR = this.gameState.teamRival.characters).splice.apply(_this$gameState$teamR, [this.gameState.teamRival.characters.length, 0].concat(_toConsumableArray(teamRival)));
      this.initialPositionChar(this.getInitialCellsPlayers(), this.gameState.teamPlayer);
      this.initialPositionChar(this.getInitialCellsRiv(), this.gameState.teamRival);
      this.gamePlay.redrawPositions(this.gameState.positionedCharacters);
    }
    ...
    value: function onCellClick(index) {
      ...
      var pos = this.gameState.positionedCharacters.find(function (elem) {
        return elem.position === index;
      });
      if (pos) {
        var _char2 = this.gameState.teamPlayer.characters.find(function (_ref11) {
        ...
        if (_char2) {
          ...
          if (this.gameState.selected === null) {
            _GamePlay__WEBPACK_IMPORTED_MODULE_36__["default"].showError('Выберите игрока своей команды!');
          } else {
            if (!(this.cellsAttack.find(function (ind) {
              return ind == index;
            }) === undefined)) {
              var selPlPos = this.gameState.positionedCharacters.find(function (_ref12) {
                var position = _ref12.position;
                return position == _this4.gameState.selected;
              });
              var attacker = selPlPos.character;
              var target = pos.character;
              var damage = Math.max(attacker.attack - target.defence, attacker.attack * 0.1);
              var promise = this.gamePlay.showDamage(index, damage);
              promise.then(function () {
                target.health = Math.max(target.health - damage, 0);
                if (target.health == 0) {
                  _this4.deleteChar(pos.position, _this4.gameState.teamRival);
                }
                _this4.gamePlay.redrawPositions(_this4.gameState.positionedCharacters);
                if (_this4.gameState.teamRival.characters.length == 0) {
                  _this4.levelCompletionControl();
                  return;
                }
                _this4.gameState.myMove = false;
                if (!_this4.gameState.myMove) {
                  setTimeout(function () {
                    _this4.execRivActions();
                  }, 1000);
                }
              });
            }
        ...
        // клик в свободную клетку

        if (this.gameState.selected === null) {
          return;
        }
        if (!(this.cellsMov.find(function (ind) {
          return ind == index;
        }) === undefined)) {
          var posPl = this.gameState.positionedCharacters.find(function (_ref13) {
            var position = _ref13.position;
            return position == _this4.gameState.selected;
          }); // экземпляр позиции игрока
    ...
    value: function onCellEnter(index) {
      ...
      if (pos) {
        var _pos$character = pos.character,
          level = _pos$character.level,
          attack = _pos$character.attack,
          defence = _pos$character.defence,
          health = _pos$character.health;
        var message = (0,_utils__WEBPACK_IMPORTED_MODULE_38__.getMessage)({
          level: level,
          attack: attack,
          defence: defence,
          health: health
    ...
    value: function onCellLeave(index) {
      ...
      var pos = this.gameState.positionedCharacters.find(function (_ref14) {
      ...
      if (!(this.cellsAttack.find(function (elem) {
        return elem == index;
      }) === undefined)) {
        this.gamePlay.deselectCell(index);
        return;
    ...
    value: function onSaveClick() {
      ...
      _GamePlay__WEBPACK_IMPORTED_MODULE_36__["default"].showMessage('Игра сохранена');
    }
  }, {
    key: "onLoadClick",
    value: function onLoadClick() {
      var _this5 = this;
      _GamePlay__WEBPACK_IMPORTED_MODULE_36__["default"].showMessage('Игра загружается');
      var load = this.stateService.load();
      if (!load) {
        _GamePlay__WEBPACK_IMPORTED_MODULE_36__["default"].showError('Ошибка загрузки');
      }
      ...
      this.pointCells = (0,_utils__WEBPACK_IMPORTED_MODULE_38__.getGameFieldMarkings)(this.gamePlay.boardSize); // координаты
      this.gameState.teamPlayer = new _Team__WEBPACK_IMPORTED_MODULE_41__["default"]();
      this.gameState.teamPlayer.scores = load.teamPlayer.scores;
      this.gameState.teamRival = new _Team__WEBPACK_IMPORTED_MODULE_41__["default"]();
      this.gameState.teamRival.scores = load.teamRival.scores;
      load.positionedCharacters.forEach(function (elem) {
        var _char3;
        switch (elem.character.type) {
          case 'swordsman':
            _char3 = new _characters_Swordsman__WEBPACK_IMPORTED_MODULE_31__["default"](elem.character.level);
            _this5.gameState.teamPlayer.addChar([_char3]);
            break;
          case 'bowman':
            _char3 = new _characters_Bowman__WEBPACK_IMPORTED_MODULE_30__["default"](elem.character.level);
            _this5.gameState.teamPlayer.addChar([_char3]);
            break;
          case 'magician':
            _char3 = new _characters_Magician__WEBPACK_IMPORTED_MODULE_32__["default"](elem.character.level);
            _this5.gameState.teamPlayer.addChar([_char3]);
            break;
          case 'undead':
            _char3 = new _characters_Undead__WEBPACK_IMPORTED_MODULE_34__["default"](elem.character.level);
            _this5.gameState.teamRival.addChar([_char3]);
            break;
          case 'vampire':
            _char3 = new _characters_Vampire__WEBPACK_IMPORTED_MODULE_33__["default"](elem.character.level);
            _this5.gameState.teamRival.addChar([_char3]);
            break;
          case 'daemon':
            _char3 = new _characters_Daemon__WEBPACK_IMPORTED_MODULE_35__["default"](elem.character.level);
            _this5.gameState.teamRival.addChar([_char3]);
            break;
          // no default
        }
        _char3.health = elem.character.health;
        _this5.gameState.positionedCharacters.push(new _PositionedCharacter__WEBPACK_IMPORTED_MODULE_29__["default"](_char3, elem.position));
      });
      this.gamePlay.drawUi((0,_utils__WEBPACK_IMPORTED_MODULE_38__.getTheme)(this.gameState.level));
      this.gamePlay.redrawPositions(this.gameState.positionedCharacters);
    }
  ...
  _createClass(GamePlay, [{
    ...
    value: function drawUi(theme) {
      ...
      for (var i = 0; i < Math.pow(this.boardSize, 2); i += 1) {
        ...
        cellEl.classList.add('cell', 'map-tile', "map-tile-".concat((0,_utils__WEBPACK_IMPORTED_MODULE_24__.calcTileType)(i, this.boardSize)));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PointCells)
/* harmony export */ });
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol.js */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description.js */ "./node_modules/core-js/modules/es.symbol.description.js");
...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
/**
 * Класс, хранящий координаты ячеек игрового поля
 **/
var PointCells = /*#__PURE__*/_createClass(
// TODO: write your logic here
function PointCells(index, row, column) {
  _classCallCheck(this, PointCells);
  this.index = index;
  this.row = row;
  this.column = column;
});
...
var Team = /*#__PURE__*/function () {
  // TODO: write your logic here
  function Team() {
    var arrChar = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  ...
  _createClass(Team, [{
    ...
    value: function addChar(_char) {
      ...
      (_this$characters = this.characters).splice.apply(_this$characters, [this.characters.lenght, 0].concat(_toConsumableArray(_char)));
    }
  }, {
    key: "countingScores",
    value: function countingScores(level) {
...
var Bowman = /*#__PURE__*/function (_Character) {
  ...
  function Bowman(level) {
    ...
    _this = _callSuper(this, Bowman, [level, 'bowman']);
    _this.attack = 25;
    _this.defence = 25;
    _this.health = 10;
    _this.rangeMov = 2;
...
var Daemon = /*#__PURE__*/function (_Character) {
  ...
  function Daemon(level) {
    ...
    _this = _callSuper(this, Daemon, [level, 'daemon']);
    _this.attack = 10;
    _this.defence = 10;
    _this.health = 10;
    _this.rangeMov = 1;
...
var Magician = /*#__PURE__*/function (_Character) {
  ...
  function Magician(level) {
    ...
    _this = _callSuper(this, Magician, [level, 'magician']);
    _this.attack = 10;
    _this.defence = 40;
    _this.health = 10;
    _this.rangeMov = 1;
...
var Swordsman = /*#__PURE__*/function (_Character) {
  ...
  function Swordsman(level) {
    ...
    _this = _callSuper(this, Swordsman, [level, 'swordsman']);
    _this.attack = 40;
    _this.defence = 10;
    _this.health = 10;
    _this.rangeMov = 4;
...
var Undead = /*#__PURE__*/function (_Character) {
  ...
  function Undead(level) {
    ...
    _this = _callSuper(this, Undead, [level, 'undead']);
    _this.attack = 40;
    _this.defence = 10;
    _this.health = 10;
    _this.rangeMov = 4;
...
var Vampire = /*#__PURE__*/function (_Character) {
  ...
  function Vampire(level) {
    ...
    _this = _callSuper(this, Vampire, [level, 'vampire']);
    _this.attack = 25;
    _this.defence = 25;
    _this.health = 10;
    _this.rangeMov = 2;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cellsGenerator: () => (/* binding */ cellsGenerator),
...
/* harmony import */ var _Team__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./Team */ "./src/js/Team.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(characterGenerator),
  _marked2 = /*#__PURE__*/_regeneratorRuntime().mark(cellsGenerator);
...
function characterGenerator(allowedTypes, maxLevel) {
  var randomTypes, randomLevel;
  return _regeneratorRuntime().wrap(function characterGenerator$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        if (false) {}
        randomTypes = Math.floor(Math.random() * allowedTypes.length);
        randomLevel = Math.floor(Math.random() * (maxLevel - 1) + 1);
        _context.next = 5;
        return new allowedTypes[randomTypes](randomLevel);
      case 5:
        _context.next = 0;
        break;
      case 7:
...
function generateTeam(allowedTypes, maxLevel, characterCount) {
  ...
  var gen = characterGenerator(allowedTypes, maxLevel);
  var members = [];
...
function cellsGenerator(count) {
  var random;
  return _regeneratorRuntime().wrap(function cellsGenerator$(_context2) {
...
/* harmony export */   getGameFieldMarkings: () => (/* binding */ getGameFieldMarkings),
...
/* harmony import */ var _PointCells__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PointCells */ "./src/js/PointCells.js");
...
function calcTileType(index, boardSize) {
  ...
  var numString = Math.floor(index / boardSize);
  var numColumn = index - numString * boardSize;
...
function getMessage(objChar) {
  return "\uD83C\uDF96".concat(objChar.level, "\u2694").concat(objChar.attack, "\uD83D\uDEE1").concat(objChar.defence, "\u2764").concat(objChar.health);
}
function getTheme(level) {
  if (level == 1) {
    return _themes__WEBPACK_IMPORTED_MODULE_2__["default"].prairie;
  }
  if (level == 2) {
    return _themes__WEBPACK_IMPORTED_MODULE_2__["default"].desert;
  }
  if (level == 3) {
    return _themes__WEBPACK_IMPORTED_MODULE_2__["default"].arctic;
  }
  if (level == 4) {
    return _themes__WEBPACK_IMPORTED_MODULE_2__["default"].mountain;
  }
}
function getGameFieldMarkings(boardSize) {
  var arr = [];
  var count = 0;
  for (var i = 0; i < boardSize; i++) {
    for (var j = 0; j < boardSize; j++) {
      arr.push(new _PointCells__WEBPACK_IMPORTED_MODULE_1__["default"](count, i, j));
      count++;
    }
  }
  return arr;
...
module.exports = __webpack_require__.p + "b27323cf850ed820855c.png";
...
module.exports = __webpack_require__.p + "ac9d74f57639792774bc.png";
...
module.exports = __webpack_require__.p + "63aae58e4690953a3857.png";
...
module.exports = __webpack_require__.p + "246277b8ca590816b3e8.png";
...
module.exports = __webpack_require__.p + "3d9503e0a850fda86f82.png";
...
module.exports = __webpack_require__.p + "22e7c5ede3f747cbe27a.png";
...
module.exports = __webpack_require__.p + "eab6a2cc5e89a4dd8e3f.png";
...
module.exports = __webpack_require__.p + "d31d84c693f649766aee.png";
...
module.exports = __webpack_require__.p + "e0aa3daf6d08c62c96d9.png";
...
module.exports = __webpack_require__.p + "cec542854b228e61547a.png";
...
module.exports = __webpack_require__.p + "cf170a9fea1051b7424a.png";
...
module.exports = __webpack_require__.p + "0a77fc47d727eab6fd39.png";
...
module.exports = __webpack_require__.p + "c0fa2b75539f94144dc4.png";
...
module.exports = __webpack_require__.p + "2007ec00c1d9f997e704.png";
...
module.exports = __webpack_require__.p + "f5c75398bcb5931f9f3c.png";
...
module.exports = __webpack_require__.p + "bf0ed0dca1d1e6091d42.png";
...
module.exports = __webpack_require__.p + "296dfeac15e2377fc1dc.png";
...
module.exports = __webpack_require__.p + "13edb269e39172ddd74f.png";
...
module.exports = __webpack_require__.p + "5cf9c17d6a1ea7106a6c.png";
...
module.exports = __webpack_require__.p + "f1703771380a9959d979.png";
...
module.exports = __webpack_require__.p + "51e2a5de56bd631452fe.png";
...
module.exports = __webpack_require__.p + "eb1f6e4f87b977012684.png";
...
module.exports = __webpack_require__.p + "2c19971f327b288278bb.png";
...
module.exports = __webpack_require__.p + "258d884122fabfc2f312.png";
...
module.exports = __webpack_require__.p + "2f1e1970c2c20cf3a8d5.png";
...
module.exports = __webpack_require__.p + "dc3f97e7bbcd5ea1ded9.png";
...
module.exports = __webpack_require__.p + "1d70f1dab2dd418c3612.png";
...
module.exports = __webpack_require__.p + "6bacb8e25ed9ecf726bf.png";
...
module.exports = __webpack_require__.p + "f462d2ed6eedca1e4fd9.png";
...
module.exports = __webpack_require__.p + "6f6f7c09bde970b2e41b.png";
...
module.exports = __webpack_require__.p + "c75f062dddba6e98fdc6.png";
...
module.exports = __webpack_require__.p + "26fdc25019c24e87f11a.png";
...
module.exports = __webpack_require__.p + "ef1b0ea8c4e545d9aadc.png";
...
module.exports = __webpack_require__.p + "a1d2321024649b9d8f5f.png";
...
module.exports = __webpack_require__.p + "8b928c3eb136543e573a.png";
...
module.exports = __webpack_require__.p + "26b5f224d8750119922d.png";
...
module.exports = __webpack_require__.p + "2429af6d3a5796e3c34b.png";
...
module.exports = __webpack_require__.p + "07d5e8127645225478b6.png";
...
module.exports = __webpack_require__.p + "0089a610e6611f679b50.png";
...
module.exports = __webpack_require__.p + "546abb060a0837550fd1.png";
...
module.exports = __webpack_require__.p + "6a84ae91f5d985ddc9ee.png";
...
module.exports = __webpack_require__.p + "46d63299c3420c030b4e.png";
...
module.exports = __webpack_require__.p + "0ac7f8258ec7166dc957.png";
...
module.exports = __webpack_require__.p + "946aeb948db6313f1d85.png";
